...
*/
const char* JSON_get_value_from_pair(char* cli_strlen_JSON, char* key)
{
	...
	const char* len_text = json_string_value(len_value_JSON); // Convert the value JSON object to string to get the length in string format
	return len_text;
}
